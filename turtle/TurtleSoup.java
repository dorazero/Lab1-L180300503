...
public class TurtleSoup {
    ...
    public static double calculateBearingToPoint(double currentBearing, int currentX, int currentY,
        ...
        //throw new RuntimeException("implement me!");
    	if(currentX == targetX && currentY == targetX)
    		return 0;
    	return (270 - currentBearing - Math.atan2((currentY - targetY), (currentX - targetX)) * 180 / Math.PI) % 360;
    }
    ...
    public static void drawPersonalArt(Turtle turtle) {
        //throw new RuntimeException("implement me!");
    	 for (int i = 0 ; i < 999; i++) {
             ...
             case 2:turtle.color(PenColor.ORANGE);break;
             case 3:turtle.color(PenColor.YELLOW);break;
             case 4:turtle.color(PenColor.GREEN);break;
             case 5:turtle.color(PenColor.CYAN);break;
             case 6:turtle.color(PenColor.BLUE);break;
             }
             turtle.turn(i/99);
             }
